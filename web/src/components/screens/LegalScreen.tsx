...
export function LegalScreen() {
  ...
  return (
    <div className="standard-screen legal-screen">
      ...
      <a className="legal-site-link" href="https://spectramsia.com/legal#calculator-privacy" target="_blank" rel="noreferrer">{t('Read the full legal and privacy notice')}</a>
    </div>
  );
}
